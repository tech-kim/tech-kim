...
# 화면 타이틀 설정
pygame.display.set_caption("A Game")  # 게임 이름
...
background = pygame.image.load(
    "C:\\Users\\joonh\\Desktop\\Pythonworkspace\\pygame_basic\\background.png")

# 캐릭터(스프라이트) 불러오기
character = pygame.image.load(
    "C:\\Users\\joonh\\Desktop\\Pythonworkspace\\pygame_basic\\character.png")
...
enemy = pygame.image.load(
    "C:\\Users\\joonh\\Desktop\\Pythonworkspace\\pygame_basic\\enemy.png")
...
# 잠시 대기
pygame.time.delay(2000)  # 2 초정도 대기 (ms)
